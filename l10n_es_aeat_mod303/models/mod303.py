...
class L10nEsAeatMod303Report(models.Model):
    ...
    casilla_69 = fields.Float(
        ...
        "[68] Annual regularization + [108] Other Adjustments",
        store=True,
    )
    ...
    casilla_111 = fields.Float(
        string="[111]",
        help="I request that the amount that, if applicable, may be refunded as a consequence of the rectification, be paid to me by bank transfer to the indicated account of which I am the account holder to the indicated bank account of which I am the account holder",
    )
